...
POST    /session/:sessionId/timeouts                          1 setTimeout                   Set Timeouts
...
GET     /session/:sessionId/window                            0 getCurrentWindowHandle       Get Window Handle
DELETE  /session/:sessionId/window                            1 close                        Close Window
...
GET     /session/:sessionId/window/rect                       0 getWindowSize                Get Window Rect
POST    /session/:sessionId/window/rect                       1 setWindowSize                Set Window Rect
...
POST    /session/:sessionId/element/:id/elements              0 findChildElement             Find Elements From Element
...
POST    /session/:sessionId/element/:id/click                 1 click                        Element Click
...
GET     /session/:sessionId/screenshot                        0 screenshotTake               Screenshot
